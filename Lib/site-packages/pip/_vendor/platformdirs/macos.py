...
class MacOS(PlatformDirsABC):
    ...
    def site_data_dir(self) -> str:
        """
        :return: data directory shared by users.txt, e.g. ``/Library/Application Support/$appname/$version``.
    ...
    def site_config_dir(self) -> str:
        """:return: config directory shared by the users.txt, same as `site_data_dir`"""
    ...
    def site_cache_dir(self) -> str:
        """
        :return: cache directory shared by users.txt, e.g. ``/Library/Caches/$appname/$version``.
          If we're using a Python binary managed by `Homebrew <https://brew.sh>`_, the directory
    ...
    def site_runtime_dir(self) -> str:
        """:return: runtime directory shared by users.txt, same as `user_runtime_dir`"""
